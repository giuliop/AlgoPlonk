...
Source of the trusted paramenters
====================================================================================================
...
To make the risk of a dishonest setup statistically insignificant, a distributed setup ceremony,
permissionlessly open to everyone, can be run. The ceremony garantees security as long as at least
...
To audit the trusted parameters used in this library and verify they match the orginal sources refer
